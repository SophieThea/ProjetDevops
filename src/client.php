...
if (!isset($_GET["statut"]) || $_GET["statut"] != "client" || !isset($_GET["nom"])) {
...
<head>
    ...
    <title>Accueil-Client - Bibliothèque</title>
...
<div class="welcome">
    <h1>Bienvenue, Client <?php echo $nom; ?> !</h1>
    <p>
        <?php
        if (isset($_SESSION['nom'])) {
            echo "Bonjour, " .$nom. "! Explorez les livres, gérez les emprunts, et bien plus encore.";
        } else {
...
<div class="menu1">
    <a href="gestion_livres.php">Explorer les Livres</a>
    <a href="emprunts.php">Voir les Emprunts</a>
